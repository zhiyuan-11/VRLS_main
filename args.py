...
class Args:
    ...
    # Subsampling
    num_client_duplicates: int = 1 #1
    num_subsample: int = -1 # 5 # -1
    ...
    # Model
    model: str = 'lenet'# 'lenet' 'resnet18'
    ...
    wandb_project: str = 'Label_Shift_ICLR24'
    wandb_entity: str = 'zhiyuanw'
    ...
    def dataloader_kwargs(self):
        return {'num_workers': 16, 'pin_memory': True} if self.device =='cuda' else {}
